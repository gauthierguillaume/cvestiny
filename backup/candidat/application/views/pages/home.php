    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="text-white mt-0">Avec Cvestiny gagné en efficacité lors de vos recrutement </h2>
                <hr class="divider light my-4">
                <p class="text-black-50 mb-4"> Notre plate-forme permet  </p>
